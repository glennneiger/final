...
export default class ProfilePicker extends Component {
  ...
  finishRegister() {
    ...
    var credentialsToStore = {
      username: credentialsSoFar.Username,
      password: credentialsSoFar.Password
    };
    ...
    return (
      <View style={[styles.whiteBackground, styles.fullScreen]}>
        ...
        >
          ...
          >
            <View style={[styles.emojiCheckerModalBody]}>
              ...
              <Text style={[{ fontSize: 30 }, styles.alignItemsCenter]}>
                Does this emoji fit you?
              </Text>
              <View style={[styles.row, { paddingTop: 30 }]}>
                ...
                // button 1<View style={{ width: 40 }} />
                // button2
                <TouchableOpacity onPress={() => this.finishRegister()}>
                  <LinearGradient
                    style={[styles.circleButton, styles.goodShadow]}
        ...
        <Text style={{ alignSelf: "center", fontSize: 17 }}>
          {" "}
          Now, choose an emoji that best describes you
        </Text>
        <View
          style={[
            {
        ...
        >
          <Text style={{ fontSize: 25, top: 40, color: "rgb(74, 74, 74)" }}>
            Pick an Emoji
          </Text>
        </View>
        <EmojiSelector
