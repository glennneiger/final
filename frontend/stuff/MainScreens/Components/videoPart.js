...
export default class VideoScreen extends Component {
  ...
  handleTap() {
    //if the user double taps the video pauses/plays, if user single taps it renders the bottom & top bars
    if (!this.state.toggled) {
      this.setState({
        toggled: true
      });
  ...
  renderBottomBar(like, save, send, comment) {
    return (
      <View
        style={[styles.whiteBackground, styles.postActionBar, styles.absolute]}
      >
        <Text style={[styles.videoCaption, { left: 6, right: 6 }]}>
          {this.state.title}
        </Text>
        ...
        <View style={styles.row}>
          <View style={[styles.spaceBetween, styles.row, { flex: 4 }]}>
            <View>
              ...
              <View style={{ height: 4 }} />
              <Text style={[styles.alignItemsCenter, styles.likeAmount]}>
          ...
          <View style={{ flex: 4 }}>
            ...
            >
              <View style={[styles.row, styles.spaceBetween]}>
                <Text
                  style={[styles.commentText, styles.bold, { top: 10 + "%" }]}
                >
                  View Comments
                </Text>
